...
configure :staging do
  config[:base_url] = ENV.fetch('BASE_URL', 'https://fcatuhe.github.io/jeangelique.com')
  set :http_prefix, '/jeangelique.com'
end

configure :production do
  config[:base_url] = ENV.fetch('BASE_URL', 'https://jeangelique.com')
